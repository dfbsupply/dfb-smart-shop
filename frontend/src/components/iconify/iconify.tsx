...
export type IconifyProps = React.ComponentProps<typeof IconRoot> &
  Omit<IconProps, 'icon'> & {
    // Registered names (see icon-sets.ts) are bundled for offline use and keep
    // editor autocomplete; any other Iconify name is allowed and loads from the
    // Iconify CDN (the admin already requires internet to sync with Firebase).
